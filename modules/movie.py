	...
	#-------------------------------------------------------------------------	
		...
		try:
			...
			for item in files:
				...
				elif fileExtension == 'mp4' or fileExtension == 'avi' or fileExtension == 'AVI' or fileExtension == 'VOB' or fileExtension == 'mkv' or fileExtension == 'mov' or fileExtension == 'MOV' or fileExtension == 'rmvb':
