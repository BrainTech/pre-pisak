...
class pilot(wx.Frame):
	def __init__(self, parent, id):
	    ...
	    self.winWidth, self.winHeight = wx.DisplaySize( )
            ...
            wx.Frame.__init__( self , parent , id, 'audiobookPilot', size = ( self.width, self.height ), pos = ( self.winWidth - self.width - self.xBorder*(self.numberOfColumns[0]-2), self.winHeight - self.height - self.xBorder*(self.numberOfRows[0]-5) ) ) 
	...
	#-------------------------------------------------------------------------	
        def initializeBitmaps(self):
            ...
            buttonPaths = glob.glob( self.pathToATPlatform + 'icons/pilots/audiobookPilot/*' ) #labelFiles
